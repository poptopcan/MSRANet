...
def eval_llcm(query_feats, query_ids, query_cam_ids, gallery_feats, gallery_ids, gallery_cam_ids, gallery_img_paths, rerank=False):
    ...
    flag = True
    if flag==True:
        return eval_llcm1(dist_mat, query_ids, gallery_ids, query_cam_ids, gallery_cam_ids, max_rank=20)
    ...
    perf = 'r1 precision = {:.2f} , r10 precision = {:.2f} , r20 precision = {:.2f}, mAP = {:.2f}, mINP = {:.2f}'
    logging.info(perf.format(r1, r10, r20, mAP,mINP))

    return mAP, r1, r5, r10, r20, mINP

def eval_llcm1(distmat, q_pids, g_pids, q_camids, g_camids, max_rank = 20):
