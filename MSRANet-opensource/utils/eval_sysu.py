...
def eval_sysu(query_feats, query_ids, query_cam_ids, gallery_feats, gallery_ids, gallery_cam_ids, gallery_img_paths,
    ...
    for t in range(num_trials):
        ...
        mINP += get_mINP(sorted_indices, query_ids, query_cam_ids, g_ids, g_cam_ids)
    ...
    perf = '{} num-shot:{} r1 precision = {:.2f} , r10 precision = {:.2f} , r20 precision = {:.2f}, mAP = {:.2f}, mINP = {:.2f}'
    logging.info(perf.format(mode, num_shots, r1, r10, r20, mAP, mINP))
